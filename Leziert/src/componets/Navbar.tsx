    ...
    hover:text-transparent"
        ...
        <div className="hidden md:block">
          <button className="relative inline-flex items-center justify-center px-6 py-2 overflow-hidden font-medium transition-all bg-blue-200 rounded-full hover:bg-white group" onClick={whatsappGo}>
           ...
           <img src="/public/whatsapp.webp" alt="" className="flex  mr-4 w-6 h-6 justify-center align-middle"/> Experimentar grátis <ChevronRight size={16} />
            </span>
          </button>
        </div>
      ...
      <div className={`fixed inset-0 bg-slate-950 z-[-1] md:hidden transition-all duration-500 ease ${
        ...
        <div className="flex flex-col items-center justify-center h-full gap-6">
          ...
          <button className="flex mt-4 px-10 py-4 bg-gradient-to-br from-blue-950to-cyan-300 text-blue-50 rounded-full font-bold" onClick={whatsappGo}>
            <img src="/public/whatsapp.webp" alt="" className="flex  mr-4 w-6 h-6 justify-center align-middle"/>
            <span className='flex justify-center'>Começar Agora</span>
